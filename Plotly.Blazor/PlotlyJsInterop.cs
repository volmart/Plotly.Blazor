...
public class PlotlyJsInterop
{
    ...
    private const string PlotlyPath = "./_content/Plotly.Blazor/plotly-3.2.0.min.js";
    private const string PlotlyBasicPath = "./_content/Plotly.Blazor/plotly-basic-3.2.0.min.js";
